...
<!--
  Align with `.specify/memory/constitution.md`. Mark N/A only with justification.
-->
...
When the feature touches AI or quant paths, include measurable outcomes compatible
with constitution baselines (e.g., schema validity 100%, citation precision,
determinism hash equality, zero unclassified gaps) or document a one-time baseline
